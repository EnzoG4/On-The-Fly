				...
				echo ("
					...
					<div class = 'container'>
						<div class = 'section'>
							<div class = 'row'>
								...
								<div class = 'col s12 m4 side' style = 'text-align: center'>
									<a class = 'waves-effect waves-light btn red lighten-2 tile modal-trigger hoverable' href = '#orderModal' ><i class = 'material-icons tile'>attach_money</i><br>Pick Up Orders</a>
								</div>
					...
					<div id = 'mapModal' class = 'modal modal-fixed-footer'>
						<div class = 'modal-content'>
  						...
  						<div class='modal-footer'>
			      			<a href='#!' class='modal-action modal-close btn-flat' >Close</a>
			      			<a class = 'waves-effect waves-light btn red lighten-2' href = 'http://cscilab.bc.edu/~choify/onthefly/pick.php'>Pick Up Orders</a>
			    		</div>
					</div>
